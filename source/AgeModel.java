...
public class AgeModel 
{
     ...
     * 
     */
    public double randomMatingWait(Random RND) {
    	return randomWaitingTime(RND,2.0/expectedParenthoodSpan(Sim.MIN_MATING_AGE_F,Sim.MAX_MATING_AGE_F));
    }
    
    public static double randomWaitingTime(Random RND, double rate)
    {	
    	double x=0;
    	if (Main.E != null && Main.E.time>101)x = (Main.Ids.size()-Main.m)/100000.0;
    	
        return -(0.5465+x)*Math.log(RND.nextDouble())/rate;
    }
